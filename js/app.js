...
let slider_about = new Swiper('.sliderLearn', {
...
//=================
//Menu
let hiddenImg = document.querySelector('.call__image');
...
if (iconMenu != null) {
	...
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			hiddenImg.classList.toggle('active');
		}
	});
};
function menu_close() {
...
const swiper = new Swiper('.sliderLearn', {
  // Optional parameters
...
const mySwiper = new Swiper('.exampleSwiper', {
  // Optional parameters
  direction: 'horizontal',
  loop: true,
  speed: 400,
...
const myOrderSlider = new Swiper('.orderSlider', {
  // Optional parameters
  direction: 'horizontal',
  loop: true,
  speed: 400,
